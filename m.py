...
def highlightFace(net, frame, conf_threshold=0.7):
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence > conf_threshold:
            ...
            cv2.rectangle(frameOpencvDnn, (x1, y1), (x2, y2), (225, 0, 0), int(round(frameHeight / 150)), 2)
...
while cv2.waitKey(1) < 0:
    ...
    for faceBox in faceBoxes:
        ...
        cv2.putText(resultImg, f'Age: {age}', (faceBox[0], faceBox[1] - 10), cv2.FONT_ITALIC, 0.8,
                    (255, 255, 255), 2)
